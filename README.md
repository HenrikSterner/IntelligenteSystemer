...
3 |PY:16,PD:2 | [Python III: Numpy](https://github.com/HenrikSterner/IntelligenteSystemer/blob/main/slides/numpy.pdf)  |ØP: 43-48 (eksl. 47),mindst 10 fra (NP) |
4 |PY:16,PD:4 | [Python IV: Matplotlib]((https://github.com/HenrikSterner/IntelligenteSystemer/blob/main/slides/slidesmatplotlib.pdf))  |ØP: 43-48(eksl. 47), alle 10 fra (MP) |
